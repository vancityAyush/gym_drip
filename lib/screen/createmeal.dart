  ...
  void _trySubmit() async {
    if (nameController.text.isEmpty) {
      Fluttertoast.showToast(
          msg: "Enter meal name", gravity: ToastGravity.BOTTOM);
    } else if (timeController.text.isEmpty) {
      Fluttertoast.showToast(msg: "Enter time", gravity: ToastGravity.BOTTOM);
    } else {
      setState(() {
        _isLoad = true;
      });
      await Provider.of<ApiManager>(context, listen: false).createMealApi(
          nameController.text,
          timeController.text,
          noteController.text,
          widget.id);
