...
class _AddTransformationState extends State<AddTransformation> {
  ...
  void _trySubmit() async {
    ...
    await Provider.of<ApiManager>(context, listen: false)
        .addTransformationApi(filename, descriptionController.text);
  ...
  Future<String> getOrganisation() async {
    var future = await Provider.of<ApiManager>(context, listen: false)
          ...
          GestureDetector(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => TransformationList()));
              },
              child: Icon(
                Icons.double_arrow,
                size: 33,
                    ...
                    Container(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            file == null ? "upload image here" : file.name,
