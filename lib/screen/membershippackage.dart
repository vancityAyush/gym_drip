...
class _MemberShipPackageState extends State<MemberShipPackage> {
  ...
  Future<String> fetchPlans() async {
    var future =
        await Provider.of<ApiManager>(context, listen: false).fetchPlansApi();
    setState(() {
      data1 = future.data;
    });
  }
  ...
  void _trySubmit() async {
    if (nameController.text.isEmpty) {
      Fluttertoast.showToast(
          msg: "Enter package name", gravity: ToastGravity.BOTTOM);
    } else if (selectedValue == null) {
      Fluttertoast.showToast(
          msg: "Select duration", gravity: ToastGravity.BOTTOM);
    } else if (priceController.text.isEmpty) {
      Fluttertoast.showToast(msg: "Enter price", gravity: ToastGravity.BOTTOM);
    } else {
      setState(() {
        _isLoad = true;
      });
